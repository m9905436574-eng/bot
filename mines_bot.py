...
# ==================== تنظیمات ====================
TOKEN = "8724613423:AAHMrCBnHfbA9TDy7cNtFmDhZQV4V_rLs40" توکن_جدید_خود_را_اینجا_از @BotFather بگیر
OWNER_ID = 8813403561  # از @userinfobot بگیر (عدد صحیح)
...
if __name__ == "__main__":
    main()    revealed = game_data["revealed"]
    bet = game_data["bet"]
    safe_count = len(revealed)
    current_multiplier = get_multiplier(safe_count)
    next_multiplier = get_multiplier(safe_count + 1)
